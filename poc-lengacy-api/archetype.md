...
This is an ASP.NET Core 8.0 Web API archetype using C#, SQLServergit status, Entity Framework Core, FluentMigrator (or EF Migrations), and a clean layered architecture. It follows best practices for separation of concerns and scalability.

## Project Structure

```text
src/
├── poc_lengacy_transformer_01/				    # Presentation Layer (Controllers)
├── poc_lengacy_transformer_01.Application/	    # Application Layer (Services, DTOs)
├── poc_lengacy_transformer_01.Domain/			# Domain Layer (Entities, Enums, Interfaces)
├── poc_lengacy_transformer_01.Infrastructure/	# Infrastructure Layer (EF, Repositories)
├── poc_lengacy_transformer_01.Tests/           # Unit and integration tests
```
## Architecture Layers
...
namespace poc_lengacy_transformer_01.Dtos
{
...
```C#
using poc_lengacy_transformer_01.Dtos;
using poc_lengacy_transformer_01.Entities;
using poc_lengacy_transformer_01.Enums;
using poc_lengacy_transformer_01.Repositories;
using Microsoft.Extensions.Logging;


namespace poc_lengacy_transformer_01.Services
{
...
namespace poc_lengacy_transformer_01.Entities
{
    [Table("users")]
    public class User
    {
...
```C#
namespace poc_lengacy_transformer_01.Enums
{
...
```C#
using poc_lengacy_transformer_01.Data;
using poc_lengacy_transformer_01.Dtos;
using poc_lengacy_transformer_01.Entities;
using poc_lengacy_transformer_01.Enums;
...
namespace poc_lengacy_transformer_01.Data
{
...
namespace poc_lengacy_transformer_01.Repositories
{
...
namespace poc_lengacy_transformer_01.Config
{
...
```C#
using poc_lengacy_transformer_01.Dtos;
using poc_lengacy_transformer_01.Services;
using Microsoft.AspNetCore.Mvc;
using Swashbuckle.AspNetCore.Annotations;
...
- **Entity** + [Table("table_name")] + classe POCO com [key]: For entities
